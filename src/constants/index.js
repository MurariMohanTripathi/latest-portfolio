...
export const myProjects = [
  {
    title: 'CampusCare – Smart Solutions for College Complaints & Communication',
    desc: "CampusCare is a centralized platform designed to manage student complaints, campus announcements, and departmental workflows.It offers role-based dashboards for students, admins, and super admins to ensure smooth communication and faster resolutions.From raising issues to receiving real-time updates, everything happens in one unified system.",
    subdesc:
      'Streamlining student complaints, announcements, and admin coordination—all in one platform.',
    href: 'https://players-e502c.web.app/',
    texture: '/textures/project/campuscare.mp4',
    logo: '/assets/CC logo.png',
    logoStyle: {
